...
namespace System.Threading.Tasks
{
	...
	public readonly struct ValueTask<TResult> : IEquatable<ValueTask<TResult>>
	{
		...
		public override int GetHashCode() => _task != null ? _task.GetHashCode() :
				 _result != null ? _result.GetHashCode() :
				 0;

		/// <summary>Returns a value indicating whether this value is equal to a specified <see cref="Object"/>.</summary>
		public override bool Equals( object obj ) => obj is ValueTask<TResult> task && Equals( task );

		/// <summary>Returns a value indicating whether this value is equal to a specified <see cref="ValueTask{TResult}"/> value.</summary>
		public bool Equals( ValueTask<TResult> other ) => _task != null || other._task != null ?
				 _task == other._task :
